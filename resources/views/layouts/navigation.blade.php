<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- New Chat Link for all roles -->
                    <x-nav-link :href="route('events.chat', ['event' => 1])" :active="request()->routeIs('events.chat')">
                        {{ __('Chat') }}
                    </x-nav-link>
                    <!--nav link for events wiew for collaborator only-->
                    @if(auth()->user()->role->name === 'Collaborator')
                       <x-nav-link :href="route('collaborator.events')" :active="request()->routeIs('collaborator.events')">
                           {{ __('My Events') }}
                       </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('events.chat', ['event' => 1])" :active="request()->routeIs('events.chat')">
                {{ __('Chat') }}
            </x-responsive-nav-link>
        </div>
